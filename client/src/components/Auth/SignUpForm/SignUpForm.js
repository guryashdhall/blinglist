...
const FormSignUp = () => {
  ...
  // };
  // title="some title";
  const [title, setTitle] = React.useState("Join us Today!");
      ...
      <form className='form' onSubmit={handleSubmit}
        ...
        <div className='form-inputs'>
          ...
          <TextField
            ...
            variant="outlined" />
          {errors.firstName && <p style={{ color: '#FF0000', alignItems: 'center', textAlign: 'center', margin: '5px' }} >{errors.firstName}</p>}
        </div>
        <br />
        <div className='form-inputs'>
        ...
        {errors.lastName && <p style={{ color: '#FF0000', alignItems: 'center', textAlign: 'center', margin: '5px' }}>{errors.lastName}</p>}
        <br />
        <div className='form-inputs'>
          <label htmlFor='email'
            className='form-label'>
        ...
        <Box sx={{ minWidth: 225 }}>
          <FormControl fullWidth>
            <InputLabel id="demo-simple-select-label"
              value={SecurityQuestion}>Security Question</InputLabel>
            <Select
            ...
            >
              ...
              <MenuItem value={"What's the brand of your first car?"}>What's the brand of your first car?</MenuItem>
            </Select>
          </FormControl>
        </Box>
        <br />
        ...
        <Button
          ...
          variant="contained"
          type='submit'
          style={{ background: '#000000' }}>Register</Button>
