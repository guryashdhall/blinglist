  ...
  return (
    <div >
        ...
        <div style={{margin: "70px"}}>
          ...
          <Typography variant='h4' align= 'center'>New Arrivals</Typography>
      
          <Grid style={{display: "flex", flexDirection: "row", justifyContent: 'space-between'}}>
            <Slider images={rings}/>
            <Slider images={necklaces}/>
            <Slider images={earrings}/>
          </Grid>
        </div>

        <div style={{margin: "70px"}}>
          <Divider style={{ width:'100%'}} />
          <Typography variant='h4' align= 'center'>You May Also Like</Typography>
        ...
        <div style={{margin: "70px"}}>
          <Divider style={{ width:'100%'}} />
          <Typography variant='h4' align= 'center'>Most Popular</Typography>
